...
| [x-cube-image-processing](https://github.com/STMicroelectronics/x-cube-image-processing) | This package enables basic and advanced image processing features on STM32 devices, supporting both software (CPU, MVE) and hardware-accelerated (GPU) implementations. |
